...
\begin{document}
    ...
    \chapter{Was ist eigentlich künstliche Intelligenz - Definition und Einleitung}
        ...
        Um eine Grundlage zu schaffen, sollte vorerst \say{Künstlicher Intelligenz}
...
\chapter{Der Traum vom mechanischen Helferlein - Geschichte}
    ...
    \section{Mensch gegen Maschine}
        ...
        Rechenleistung bisher noch nicht geknackt worden. Dazu bedarf es erst einem \say{Verständnis} von Schach, dass bis zu diesem
...
\chapter{Schwache versus starke Arten von KI}
    ...
    \section{Starke KI}
        ...
        \begin{displayquote}
            ...
            Dazu zählen wissenschaftliche Kreativität, allgemeine Weisheit und jegliche soziale Fähigkeiten.}\cite{bostrom1998long}
        \end{displayquote}
        Zwar legen sich sowohl Vinge als auch Bostrom nicht auf eine starke KI als Übergangspunkt
        zur \say{Technologischen Singularität}\cite{vinge1993technological} oder \say{Superintelligenz}\cite{bostrom1998long} fest,
...
\chapter{Gedankenexperimente}
    ...
    greifbar zu machen.
    Ein Computer der keinerlei Verbindung in die Realität eines Menschen hat, kann zwar Regeln lernen, die ihm die
    ...
    Damit vertritt Searle eine Position, die sich gegen das Entstehen einer starken KI stellt.
...
\chapter{Fazit/Schlussfolgerung}
    Trotz ihres jungen Alters ist \say{Künstliche Intelligenz} eine heute schon häufig eingesetzte Technologie.
    ...
    Falls eine KI diese Fähigkeit erlangt, ist das Entstehen einer \say{Superintelligenz} so gut wie sicher.
