...
\chapter{Technische Grundlagen}
     ...
     möglich mithifel von ML ein Modell (ML-Modell) zu generieren,
     sein Ziel zuverlässig erfüllen kann.
    ...
    \subsection{Top-Down Methode (Deduktiv)}
        ...
        \subsubsection{Supervised Learning}
            Mit dieser Art des Lernens kann man zwei verschiedene Problemkategorien lösen:
            \begin{itemize}
            ...
            Das Lösen beider Problemarten erfordert das Kennzeichnen bzw. Labeln der Datenpunkte.
            ...
            Vorteil dieser Art des Lernens ist ein hoher Einfluss auf das Ergebnis des Lernens,
