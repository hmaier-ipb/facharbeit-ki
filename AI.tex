...
% Bottom of the page
    ...
    Der Begriff \emph{Intelligenz} kommt vom lateinischen \say{intelligere}. Dies bedeutet Einsehen, Begreifen und Erkennen.\footfullcite{piaget2000psychologie}
    ...
    Wein nachschenkten.\footfullcite[53]{buchanan2005very} Auch wenn diese Verwendung von KI aus unserem heutigen Standpunkt
    ...
    die aufgrund von logischen Regeln Rechtsfälle aushandeln.\footfullcite[53]{buchanan2005very}
    ...
    brauchte es Mitte des 20. Jahrhunderts erst den Mathematiker Alan Turing.\footfullcite{sesink1993menschliche}
    ...
    gegen den Schach-Weltmeister Gary Kasparov.\footfullcite{hsu1999ibm}
    ...
    wissenschaftlicher Perspektiven\footfullcite{buchanan2005very} bedurfte, um zur modernen Idee der \say{Künstlichen Intelligenz} zu gelangen.
    Dazu gehören Disziplinen wie Biologie, Logik und Philosophie, Maschinenbau und Psychologie.\footfullcite[56]{buchanan2005very}
    ...
    die Idee eines Roboters der sowohl als mechanischer Diener als auch als selbstdenkender Künstler agieren kann.\footfullcite{asimov2000der}
    ...
    maschinellen Lernen trainiert worden sind.\footfullcite{ibm2021whatisAI} Diese Art der KI erfüllt vordefinierte Aufgaben,
    ...
    \begin{displayquote}
        ...
        Ziel der befragten Person ist es dem Fragenden bei der Identfikaton der Maschine zu helfen.\footfullcite{turing1950computing}
    \end{displayquote}
    ...
    bezeichnet wird.\footfullcite{oppy&dowe2020turingtest}. Ein solches denkfähiges Wesen besitzt die Fähigkeit verschiedene Problemstellungen
    ...
    \section{Turing Test}
    \footfullcite{turing1950computing}
    ...
    \footfullcite{nimtz2013chinesische}
