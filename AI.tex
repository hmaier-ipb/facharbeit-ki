...
% Bottom of the page
    ...
    \section{Maschinelles Lernen)
        Um als einem Dataset ein Modell zu gewinnen gibt es zwei Methoden. Die erste Methode ist beaufsichtigtes Lernen (supervised learning) und
        die zweite Methode ist unbeaufsichtigtes Lernen (unsupervised learning). Die Beaufsichtigung des Lernens spielt dabei auf
        das Eingreifens des Menschen in den Lernprozess ein.
