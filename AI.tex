...
% Bottom of the page
    ...
    anerkannt.
    \say{Künstlich} verweist in diesem Zusammenhang auf die unnatürliche Herkunft dieser Intelligenz. Das \say{künstliche} ist also etwas, was
    ...
    \end{displayquote}
    Dies ist eine absolute und perfekte Definition von \say{künstlicher Intelligenz} die bis zum heutigen Zeitpunkt noch nicht erschaffen
    worden ist.\footnote{Mehr dazu in Kapitel Starke versus Schwache KI.} Ob dieses Ziel jemals erreicht werden wird ist ebenfalls noch nicht klar.
    \footnote{Dazu gibt es verschiedene Meinungen die im Kapitel \textbf{Gedankenexperimente} erläutert werden.}
    Falls diese Definition einer \say{künstlichen Intelligenz} jemals erschaffen werden würde, wäre dies vergleichbar
    mit der Erfindung des Feuers. Ein vom Menschen erschaffenes Wesen könnte wirklich \emph{alle}Aufgaben übernehmen die
    bisher dem Menschen vorbehalten waren.
